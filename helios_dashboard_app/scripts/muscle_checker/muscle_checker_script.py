...
def run(file: str) -> dict:
    ...
    """
    all_muscles = json_file_to_dict('helios_dashboard_app/scripts/muscle_checker/all_muscles.json')
...
def run_string(string: str):
    ...
    """
    f = open("helios_dashboard_app/scripts/muscle_checker/insert_calendar_text.txt", "w")  # Opens the file to be overwritten ("w").
    f.write(string + "\n")
    f.close()

    return run("helios_dashboard_app/scripts/muscle_checker/insert_calendar_text.txt")


def update_txt_file(string: str) -> bool:

    f = open("helios_dashboard_app/scripts/muscle_checker/insert_calendar_text.txt", "w")
    f.write(string + "\n")
    f.close()
...
if __name__ == "__main__":  # Default method to run.
    ...
    parser.add_argument("-f", "--file", help="Sets the location of insert_calendar_text.txt.", default="helios_dashboard_app/scripts/muscle_checker/insert_calendar_text.txt", type=str)
